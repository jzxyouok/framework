 ...
 * logic. The "leaps migrate" command manages all available migrations in an application.
 *
 ...
 * @since 2.0
 */
class Migration extends \Leaps\Base\Component
{
	/**
	...
	public function init()
	{
		parent::init();
		if ($this->db === null) {
			$this->db = Leaps::$app->getComponent('db');
		}
	}
