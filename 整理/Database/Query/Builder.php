...
use Closure;
use Leaps\Support\Collection;
use Leaps\Database\ConnectionInterface;
use Leaps\Database\Query\Grammars\Grammar;
...
class Builder {
	 ...
	 *
	 * @param  \Leaps\Database\ConnectionInterface  $connection
	 * @param  \Leaps\Database\Query\Grammars\Grammar  $grammar
	 * @param  \Leaps\Database\Query\Processors\Processor  $processor
	 * @return void
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \Leaps\Database\Query\Builder|static
	 */
	 ...
	 *
	 * @param  \Leaps\Database\Query\Builder|\Closure  $query
	 * @param  bool $all
	 * @return \Leaps\Database\Query\Builder|static
	 */
...
$results = new Collection($this->get($columns));
	 ...
	 *
	 * @param  \Leaps\Pagination\Environment  $paginator
	 * @param  int    $perPage
	 * @param  array  $columns
	 * @return \Leaps\Pagination\Paginator
	 */
...
foreach ($values as $record)
	 ...
	 *
	 * @return \Leaps\Database\ConnectionInterface
	 */
