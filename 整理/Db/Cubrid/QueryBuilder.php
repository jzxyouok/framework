 ...
 */
namespace Leaps\Db\Cubrid;
use Leaps\Base\InvalidParamException;

/**
 * QueryBuilder CUBRID数据库查询构建器(版本9.1。x和更高版本)。
 *
 * @author Tongle Xu <xutongle@gmail.com>
 * @since 5.0
 */
class QueryBuilder extends \Leaps\Db\QueryBuilder
{
	/**
	 * 从抽象的列类型(钥匙)映射到物理列类型(值)。
	 * @var array
	 */
	public $typeMap = [
