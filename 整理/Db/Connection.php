...
class Connection extends Component
{
	 ...
	 * schema class name or configuration. Please refer to [[Leaps::createObject()]] for
	...
	{
		if ($this->pdo !== null) {
			Leaps::trace('Closing DB connection: ' . $this->dsn, __METHOD__);
			$this->pdo = null;
			$this->_schema = null;
	...
	public function getSchema()
	{
		if ($this->_schema !== null) {
			...
			if (isset($this->schemaMap[$driver])) {
				$this->_schema = Leaps::createObject($this->schemaMap[$driver]);
